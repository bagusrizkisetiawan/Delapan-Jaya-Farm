...
class AddJadwalActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContent {
            DelapanJayaFarmTheme {
                AddJadwalScreen(onBackPressed = { finish() })
            }
        }
    }
}
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                ...
                title = {
                    Text("Tambah Jadwal", fontSize = 20.sp)
                },
                navigationIcon = {
                    //
        ...
        Column(
            ...
            Button(
                onClick = {
                    ...
                    val jadwal = Jadwal(jam = jam, namaJadwal = namaJadwal, keterangan = keterangan)
                    jadwalViewModel.addJadwal(jadwal)
